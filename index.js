...
const processWeatherData = async (data, cityName) => {
    ...
    if (!foundData) {
        throw new Error('Niestety nie mamy danych na temat tego miasta')
    }
    ...
    const weatherInfo = `In ${cityName} there is ${temperature}°C, ${humidity} % of humidity and preasure of ${preasure} hPa.`;
